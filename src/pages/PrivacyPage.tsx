            ...
            <main className="pt-28 pb-16">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    >
                        <section id="general" aria-label="Общие положения">
                            ...
                            <div className="space-y-4 text-sm text-foreground/80 leading-relaxed">
                                <p>
                                    ...
                                    которую <strong>ЧОУ СОШ «Личность Плюс»</strong> (ИНН 2368015470, КПП 236801001, ОГРН 1212300048179, адрес: 353292, Краснодарский край, г. Горячий Ключ, пер. Школьный, д. 27) может получить о пользователе
                                    во время использования сайта <a href="/" className="text-primary hover:underline">slp23.ru</a>.
                                </p>
                                <p>
                        ...
                        <section id="data-protection" aria-label="Защита данных">
                            ...
                            <div className="space-y-4 text-sm text-foreground/80 leading-relaxed">
                                ...
                                <ul className="list-disc list-inside space-y-2 ml-4">
                                    ...
                                    <li>Соблюдение требований ФЗ-152 «О персональных данных», включая требования по локализации данных на серверах в РФ</li>
                                </ul>
                            </div>
                        </section>
                        ...
                        <section id="requisites" aria-label="Реквизиты организации">
                            <h2 className="text-2xl font-bold text-foreground mb-4 tracking-tight">8. Реквизиты организации</h2>
                            <div className="grid md:grid-cols-2 gap-6 text-sm text-foreground/80 leading-relaxed">
                                <div className="space-y-2">
                                    <p><strong>Наименование:</strong> ЧОУ СОШ «Личность Плюс»</p>
                                    <p><strong>ИНН:</strong> 2368015470</p>
                                    <p><strong>КПП:</strong> 236801001</p>
                                    <p><strong>ОГРН:</strong> 1212300048179 (от 18.08.2021)</p>
                                    <p><strong>Юридический адрес:</strong> 353292, Краснодарский край, г. Горячий Ключ, пер. Школьный, д. 27</p>
                                    <p><strong>Руководитель:</strong> Директор Киян Юлия Юрьевна</p>
                                </div>
                                <div className="space-y-2">
                                    <p><strong>ОКПО:</strong> 53566960</p>
                                    <p><strong>ОКАТО:</strong> 03409000000</p>
                                    <p><strong>ОКТМО:</strong> 03504000001</p>
                                    <p><strong>ОКФС:</strong> 16 (Частная собственность)</p>
                                    <p><strong>ОКОГУ:</strong> 4210014</p>
                                    <p><strong>ОКОПФ:</strong> 75500</p>
                                    <p><strong>Основной вид деятельности:</strong> Образование дошкольное (85.11)</p>
                                </div>
                            </div>
                        </section>
